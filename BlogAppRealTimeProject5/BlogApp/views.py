...
def post_list_view(requst):
    post_list=Post.objects.all()
    return render(requst,'BlogApp/post_list.html',{"post_list":post_list})
...
#send_mail('hello','very imp msg','kchaithanya881@gmail.com',['pavankalyanthammisetty2000@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'kchaithanya881@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=False;
    else:
	    form=EmailSendForm()
